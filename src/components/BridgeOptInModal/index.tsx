...
import {
  BRIDGE_FIELD_LABELS,
  BRIDGE_FIELD_DESCRIPTIONS,
} from "constants/bridgeIntegration";
      ...
      <Modal.Body>
        <div className="BridgeOptInModal">
          ...
          <div className="BridgeOptInModal__intro">
            <p>
              Bridge enables you to source liquidity via USD deposits that
              automatically convert to USDC on Stellar. Complete the form below
          ...
          <form onSubmit={handleSubmit}>
            <div className="BridgeOptInModal__form">
              <div className="BridgeOptInModal__row">
                <Input
                  id="fullName"
              ...
              <div className="BridgeOptInModal__kycType">
                <div className="BridgeOptInModal__fieldLabel">
                  {BRIDGE_FIELD_LABELS.KYC_TYPE}
                </div>
                <div className="BridgeOptInModal__radioGroup">
                  <RadioButton
                    id="kyc-individual"
                    name="kycType"
                    label={BRIDGE_FIELD_LABELS.INDIVIDUAL}
                    value="individual"
                  ...
                  <RadioButton
                    id="kyc-business"
                    name="kycType"
                    label={BRIDGE_FIELD_LABELS.BUSINESS}
                    value="business"
                ...
                <div className="BridgeOptInModal__fieldNote">
                  {BRIDGE_FIELD_DESCRIPTIONS.KYC_TYPE}
                </div>
              </div>
            </div>
          </form>
